...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section className="relative w-full h-screen overflow-hidden bg-surface-container-lowest">
          ...
          {PANELS.map((p, i) => (
            <div
              ...
              style={{
                ...
                height: p.height,
                opacity: p.opacity,
                animation: `hero-panel 1s cubic-bezier(0.16,1,0.3,1) ${p.delay} both`,
              }}
            />
          ))}
        ...
        <div className="relative z-10 h-full flex flex-col justify-end p-5 md:p-10 lg:p-16">
          <h1
            ...
            style={{ animation: "hero-rise 1s cubic-bezier(0.16,1,0.3,1) 0.2s both" }}
          >
            {t("hero.title")}
          </h1>
          ...
          <div
            ...
            style={{ animation: "hero-rise 1s cubic-bezier(0.16,1,0.3,1) 0.32s both" }}
          >
            {/* Left blurbs */}
